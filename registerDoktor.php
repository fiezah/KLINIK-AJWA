<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.3.org.TR/xhtml1/DTDxhtml1-transitional.dtd">
...
<?php
//This query inserts a record in the clinik table
...
if (empty($_POST ['FirstName'])){
    $error[] = 'Your forgot to enter your first Name.';
} else{
...
if(empty($_POST['Specialization'])){
    $error [] = 'You forgot to enter specialization.';
}
else{
...
if (empty($_POST['Password'])){
    ...
    echo '<h1>Thank You for your service!<h1>';
    exit();
    }else {   //if it did run
    //message
...
<p><label class ="label" for ="FirstName"> FirstName : *</label>
...
<p><label class ="label" for ="LastName"> LastName : *</label>
